...
require_once $_SERVER['DOCUMENT_ROOT']."/pay/wx/WxPay.Exception.php";
require_once $_SERVER['DOCUMENT_ROOT']."/pay/wx/WxPay.Config.php";
require_once $_SERVER['DOCUMENT_ROOT']."/pay/wx/WxPay.Data.php";
