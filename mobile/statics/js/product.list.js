...
function getData(pagenumber) {
    // console.log(condition_old.default+'-'+condition_old.click+'-'+condition_old.sale+'-'+condition_old.price+'-'+condition_old.brand_id)
    // console.log(condition.default+'-'+condition.click+'-'+condition.sale+'-'+condition.price+'-'+condition.brand_id)
    // console.log('-------------------------')
...
function insertDiv(json) {
    ...
    if(json.length > 0){
        ...
        if(condition.brand==1 && condition.brand_id>0){
            $('.page_header .pagetitle').html(json[0].brand_name);
        }else{
            $('.page_header .pagetitle').html(document.title);
        }
    }
