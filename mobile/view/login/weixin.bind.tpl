        ...
        <section class="socailbindbox">
            <div class="inbox">
                <div class="user_profile">
                    <div class="imgbox"><img src="{$user_profile.img_url}" width="100%" /></div>
                    <div class="titlebox">
                        <span>微信账号</span>{$user_profile.nickname}
                        <p><a href="/h5/subscribe.html">点击关注，并绑定微信号<br>可享25BOY购物全场包邮！</a></p>
                        {*if $subscribe==0*}
                        {*<span>未关注用户</span>{$user_profile.nickname}*}
                        {*<p><a href="/h5/subscribe.html">点击关注，可享购物免运费<br>还有更多25BOY会员专有福利哦！</a></p>*}
                        {*/if*}
                    </div>
                </div>
                <div class="tabbox">
                ...
                <div class="subject pb10 new_account icon-relative">
                    ...
                    <button class="button_get_code" onclick="get_code(this,33)">获取验证码</button>

                </div>

                <div class="subject pb10 new_account icon-relative">
                    <i class="iconfont icon-font">&#xe645;</i>
                    <input type="text" id="nickname" value="{$user_profile.nickname}" class="ex-text" placeholder="请输入昵称" />
                    <i class="iconfont icon-close">&#xe639;</i>
                </div>
                ...
                <input type="hidden" id="avatar_hd" value="{$user_profile.img_url}" />
        ...
        if (!user.isJson(json)) {
            ...
            if(json.status=="success"){
                ...
                if(json.had_account==1){
                    title = "成功登录并绑定账户";
                    remark = "恭喜您，"+json.nickname+"<br />您已经成功登录并绑定了微信账户，现在你可享用会员功能了。<br/>该窗口2秒后关闭。";
                }else{
                    title = "成功创建并绑定账户";
                    remark = "恭喜您，"+json.nickname+"<br />您已注册为25boy会员并绑定了微信账户！";
                    if(json.coupon){
