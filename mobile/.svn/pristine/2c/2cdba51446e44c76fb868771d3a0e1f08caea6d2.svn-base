...
class JsApiPay
{
	...
	public function getAccessToken(){
		$access_token_file = $_SERVER['DOCUMENT_ROOT'] . '/temp/access_token.json';//json文件路径
		...
		if(is_file($access_token_file)){
			...
			if(isset($access_token_data['expiration_time']) && $access_token_data['expiration_time'] > (time()+60)){
