        ...
        <section class="socailbindbox">
            <div class="inbox">
                <div class="user_profile">
                    ...
                    <div class="titlebox">
                        <span>微博账号:</span>{$user_profile.name}
                ...
                <div class="subject pb10 new_account icon-relative">
                    <i class="iconfont icon-font">&#xe645;</i>
                    <input type="text" id="nickname" value="{$user_profile.name}" class="ex-text" placeholder="请输入昵称" />
                    <i class="iconfont icon-close">&#xe639;</i>
                </div>
            ...
            if (!user.isJson(json)) {
                ...
                if(json.status=="success"){
                    ...
                    if(json.had_account==1){
                        title = "成功登录并绑定账户";
                        remark = "恭喜您，"+json.nickname+"<br />您已经成功登录并绑定了微博账户，现在你可享用会员功能了。<br/>该窗口2秒后关闭。";
                    }else{
                        title = "成功创建并绑定账户";
                        remark = "恭喜您，"+json.nickname+"<br />您已注册为25boy会员并绑定了微博账户！";
                        if(json.coupon){
