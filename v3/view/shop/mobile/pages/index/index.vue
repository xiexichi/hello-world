      ...
      <div class="home-panel">
        <div class="home-panel-title">
          <span class="title-line">热门品类</span>
					<van-icon name="more" class-prefix="myicon" class="title-more" @click="$helper.goto('/pages/categorys/index')"  />
        </div>
      ...
      <div class="home-panel">
        <div class="home-panel-title">
          <span class="title-line">达人晒图</span>
					<van-icon name="more" class-prefix="myicon" class="title-more" @click="$helper.goto('/pages/share/index')"  />
        </div>
