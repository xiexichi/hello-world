<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"D:\project\v3\view\shop\shop-o2o\public/../application//order/view/refund/list.html";i:1555997870;}*/ ?>
<style type="text/css">
...
<script id="toolbarTpl" type="text/html">
	<div class="layui-btn-group">
		<button class="layui-btn layui-btn-primary layui-btn-sm"><i class="layui-icon layui-icon-close"></i>作废</button>
		<button class="layui-btn layui-btn-primary layui-btn-sm"><i class="layui-icon layui-icon-rmb"></i>支付</button>
		<button class="layui-btn layui-btn-primary layui-btn-sm"><i class="layui-icon layui-icon-release"></i>发货</button>
		<button class="layui-btn layui-btn-primary layui-btn-sm"><i class="layui-icon layui-icon-upload-drag"></i>同步ERP</button>
		<button class="layui-btn layui-btn-primary layui-btn-sm"><i class="layui-icon layui-icon-edit"></i>备注</button>
		<button class="layui-btn layui-btn-primary layui-btn-sm"><i class="layui-icon layui-icon-file"></i>打印小票</button>
	</div>
</script>

<!-- checkout -->
<script type="text/javascript" charset="utf-8" src="/static/js/order/refund.js"></script>
