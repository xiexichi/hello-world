<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"D:\project\v3\view\admin\app\public/../application//picshow/view/position/list.html";i:1551405380;s:82:"D:\project\v3\view\admin\app\public/../application//common/view/common/layout.html";i:1551405380;s:45:"../application/common/view/common/header.html";i:1551405380;s:45:"../application/common/view/common/footer.html";i:1546909578;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
			...
			<div class="layui-card-header layuiadmin-card-header-auto">
				<div class="layui-form-item layui-inline">
					...
					<div class="layui-input-inline">
						<select name="platform_code" id="platformCode">
				...
				<div class="layui-form-item layui-inline">
					...
					<div class="layui-input-inline">
						<input type="text" name="position_name" placeholder="模糊匹配" class="layui-input" value="<?php echo \think\Request::instance()->param('position_name'); ?>">
					</div>
				</div>
			</div>
		</form>
...
<script type="text/html" id="ctrlTpl">
	...
	<a class="layui-btn layui-btn-xs" href="/picshow/index/list?position_id={{d.id}}">广告列表</a>
...
<script type="text/javascript" charset="utf-8" src="/static/js/picshow/position.js"></script>
</body>
</html>