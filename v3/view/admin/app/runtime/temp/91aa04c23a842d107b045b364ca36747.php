<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:84:"D:\project\v3\view\admin\app\public/../application//activity/view/coupon/detail.html";i:1556084135;s:82:"D:\project\v3\view\admin\app\public/../application//common/view/common/layout.html";i:1551405380;s:45:"../application/common/view/common/header.html";i:1551405380;s:45:"../application/common/view/common/footer.html";i:1546909578;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
    ...
    <div class="layui-card">
        <div class="layui-card-body">
            <form class="layui-form table-box" lay-filter="form-table" action=""  >
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">领券时间：</label>
                    <div class="layui-input-inline">
                        <input type="text" name="get_start_time" id="get_start_time" v-model="coupon_info.get_start_time" placeholder="开始时间" autocomplete="off" class="layui-input">
                    </div>
                    <div class="layui-form-mid">至</div>
                    <div class="layui-input-inline">
                        <input type="text" name="get_end_time" id="get_end_time" v-model="coupon_info.get_end_time" autocomplete="off" class="layui-input" placeholder="结束时间" >
                    </div>
                    <div class="layui-form-mid layui-word-aux" >（结束时间为空则为永久可领，开始时间为空则为结束时间前可领，两个时间都为空则不限时间）</div>
                </div>
                <div class="layui-form-item">
...
<script>
    ...
    var Vue = new Vue({
        ...
        mounted:function(){
            ...
            laydate.render({
                elem: '#get_start_time', //指定元素
                type: 'datetime',
                done: function(value, date, endDate){
                    that.coupon_info.get_start_time = value;
                }
            });
            laydate.render({
                elem: '#get_end_time', //指定元素
                type: 'datetime',
                done: function(value, date, endDate){
                    that.coupon_info.get_end_time = value;
                }
            });
            laydate.render({
                ...
                type: 'datetime',
                    ...
                    that.coupon_info.start_time = value;
                }
            });
            laydate.render({
                elem: '#end_time', //指定元素
                type: 'datetime',
                    ...
                    that.coupon_info.end_time = value;
                }
            });
            form.render();
        },
                ...
                request.setHost(SHOP_DATA).post('/activity/coupon/one',param, function(res){
                    if (res.code == 0) {
                        that.coupon_info = {
                            ...
                            'get_start_time' : res.data.get_start_time,
                            'get_end_time' : res.data.get_end_time,
