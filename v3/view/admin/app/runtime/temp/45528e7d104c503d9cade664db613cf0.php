...
<script>
    ...
    $(document).ready(function(){
        ...
        var param = {};
        param.id = id;
        request.setHost(SHOP_DATA).post('/goods/goods_prop_val/one',param, function(res){
            if (res.code == 0) {
