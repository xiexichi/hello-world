<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"D:\project\v3\view\admin\app\public/../application//goods/view/attribute/list.html";i:1548913060;}*/ ?>
<!--导航-->
...
<script type="text/javascript">
    ...
    function loadlist(){
        ...
        table.render({
            ...
            ,page: true
            ,toolbar: '<div>' +
                '<button class="layui-btn layui-btn-sm" onclick="add()">添加参数'+
                '</button>' +
                '</div>'
            ,headers: {
                ctrl: SHOP_DATA
