<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:97:"D:\project\v3\view\admin\app\public/../application//powershop/view/power_controller/page_add.html";i:1555997868;s:82:"D:\project\v3\view\admin\app\public/../application//common/view/common/layout.html";i:1551405380;s:45:"../application/common/view/common/header.html";i:1551405380;s:45:"../application/common/view/common/footer.html";i:1546909578;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
    ...
    $(document).ready(function(){
        ...
        layui.use('form', function(){
            ...
            form.on('submit(formAdd)', function(data){
                request.setHost(SHOP_DATA).post('/power/power_controller/add', data.field, function(res){console.log(res);
                    if (res.code == 0) {
                        // 成功提示
                        layer.msg(res.msg);
                        setTimeout(function(){
