...
<script type="text/javascript">
    ...
    layui.use(['layer','laytpl','form'], function(){
        form.on('submit(formAdd)', function (data) {
            ...
            request.setHost(SHOP_DATA).post('/power/power_group/add', data.field, function (res){
