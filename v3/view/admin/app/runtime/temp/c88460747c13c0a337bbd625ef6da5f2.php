<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\project\v3\view\admin\app\public/../application/index\view\index\index.html";i:1556611850;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="layui-layout layui-layout-admin">
            <div class="layui-header">
                ...
                <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                    ...
                    <li class="layui-nav-item" lay-unselect>
                        <a href="javascript:;">
                            <cite><?php echo $adminInfo['realname']; ?></cite>
                        </a>
...
<!--                         <?php if(is_array($menu) || $menu instanceof \think\Collection || $menu instanceof \think\Paginator): if( count($menu)==0 ) : echo "" ;else: foreach($menu as $k=>$v): ?>
                        ...
                        <li data-name="order" class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                ...
                                <dd><a lay-href="/test/test/test.html">测试列表</a></dd>
                            </dl>
                        </li>
                        <li data-name="goods" class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                ...
                                <dd><a lay-href="/share/share_activity/page_list.html">晒图营销</a></dd>
                            </dl>
                        </li>
                        ...
                        <li data-name="user" class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd><a lay-href="/user/user/page_list.html">会员列表</a></dd>
                                <dd><a lay-href="/user/user_level/page_list.html">会员等级列表</a></dd>
                                <dd><a lay-href="/user/user_integral_setting/page_edit.html">会员积分设置</a></dd>
                                <dd><a lay-href="/user/user_integral/page_list.html">会员积分记录</a></dd>
                        ...
                        <li data-name="home" class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                ...
                                <dd data-name="sell"><a lay-href="/merchant/meregion/page_list.html">区域管理</a></dd>
                            </dl>
                        </li>
                        ...
                        <li data-name="power" class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd><a lay-href="/power/admin/page_list.html">管理员管理</a></dd>
                                <dd><a lay-href="/power/power_role/page_list.html">角色管理</a></dd>
                                <dd><a lay-href="/power/power_group/page_list.html">权限组管理</a></dd>
                            </dl>
                        </li>
                        <li data-name="powerShop" class="layui-nav-item">
                            <a href="javascript:;" lay-tips="店铺权限管理" lay-direction="2">
                                <i class="layui-icon layui-icon-auz"></i>
                                <cite>店铺权限管理</cite>
                            </a>
                            <dl class="layui-nav-child">
                                <dd><a lay-href="/powerShop/power_group/page_list.html">权限组管理</a></dd>
                            </dl>
                        </li>
