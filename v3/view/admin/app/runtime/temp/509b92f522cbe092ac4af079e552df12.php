<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:89:"D:\project\v3\view\admin\app\public/../application//article/view/categorys/cate_edit.html";i:1553048691;s:82:"D:\project\v3\view\admin\app\public/../application//common/view/common/layout.html";i:1551405380;s:45:"../application/common/view/common/header.html";i:1551405380;s:45:"../application/common/view/common/footer.html";i:1546909578;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<form class="layui-form table-box" action="" lay-filter="edit">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="desc" required  lay-verify="required" placeholder="描述" autocomplete="off" class="layui-input" >
        </div>
    </div>
...
<script src="/static/js/article/cate_edit.js"></script>
