<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"D:\project\v3\view\admin\app\public/../application//power/view/admin/page_add.html";i:1556957787;s:82:"D:\project\v3\view\admin\app\public/../application//common/view/common/layout.html";i:1551405380;s:45:"../application/common/view/common/header.html";i:1551405380;s:45:"../application/common/view/common/footer.html";i:1546909578;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        layui.use(['jquery', 'form', 'layer', 'laytpl'], function(){
            ...
            request.setHost(CENTER_DATA).get('/power/admin/getAddData',{}, function(res){
                if( res.code == 0 ){
